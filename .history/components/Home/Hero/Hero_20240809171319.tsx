      ...
      <div className="w-4/5 mx-auto items-center grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="col-span-2">
          ...
          <div className="flex items-center space-x-2 mt-10">
            <button className="w-36 rounded-full py-3 px-8 text-center bg-blue-700 font-semibold text-white transition-all hover:bg-blue-600">
              Upload
            </button>
            <button className="w-36 rounded-full py-3 px-8 text-center bg-rose-900 font-semibold text-white transition-all hover:bg-blue-950">
              Explore
            </button>
          </div>
        </div>
